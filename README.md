...
- 連勤は6日まで
- 各シフトに毎日1人以上
- 遅番の翌日は「休み」「遅番」「その1つ前のシフト」だけ（勤務間インターバル11時間の近似）
...
|---|---|
| 人数 | 3〜50人 |
| シフト数 | 2〜人数の8割（入力欄に「8人なら最大 6」と表示されます） |
| 日数 | 28〜31日 |

シフト数の上限が人数で変わるのは、各シフトに毎日1人以上置くと1日の休み枠が
「人数 − シフト数」しか残らないためです。ここが細りすぎると連勤6日以内を守れなくなります。
...
| 連休（2連休以上）の確保 | 休みを等間隔に散らす方針の裏返しで2連休はほぼ出ない。連休を作ると他の日の休みが痩せる。必要かは職場ごとに違うため手直しの領域 |
...
|---|---|---|---|---|
| 8人×3シフト×30日 | 0.24s | 1日 | 1回 | 0 |
| 20人×3シフト×31日 | 0.47s | 1日 | 1回 | 0 |
| 50人×4シフト×31日 | 0.82s | 1日 | 1回 | 0 |
| 20人×10シフト×31日 | 0.34s | 1日 | 1回 | 0 |
| 25人×20シフト×31日 | 0.45s | 3日 | 1回 | 0 |
| 50人×40シフト×31日 | 0.86s | 4日 | 1回 | 0 |
